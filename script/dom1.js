...
//window.document.write('hello google :)')
...
function internet2(){
    window.open("https://google.com", "_blank", 'width=500, heigh=500')
}
/* 
    인라인 스크립트
    1. 함수, 변수 등 자바스크립트는 JS 파일내에서 작성
    2. 상호작용이 필요한 HTML 태그에 JS 연결을 위해서 태그 내에 이벤트(ex)onClick)등오로 함수 연결
...
//() 선택하는 "태그명" 작성
//객체.메서드()
//선택한 DOM태그 내에 자식, 자손까지 포함해서 선택한다.
