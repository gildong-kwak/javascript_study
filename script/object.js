...
/* const movie = {
    ...
    appeal_point:['감독연출','OST','스토리','배우연기','영상미'],
    emotion_point:['스트레스 해소','감동','몰입감','공감','유쾌함'],
...
console.log(cat_shelter[0].age) //test(안전하게 먼저 테그 해보기)
